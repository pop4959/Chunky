...
public class ForgeChunkyCommand extends BrigadierChunkyCommand<CommandSourceStack, Identifier, EntitySelector> {

    private final Supplier<Chunky> chunky;

    public ForgeChunkyCommand(final Supplier<Chunky> chunky) {
        this.chunky = chunky;
    }
