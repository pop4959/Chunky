...
public class SpiralChunkCoordinateIterator implements ChunkCoordinateIterator {
    ...
    public SpiralChunkCoordinateIterator(int radius, int chunkX, int chunkZ, int startCount) {
        ...
        subCount = (startCount - stretchStart) % stretchStart + 1;
    ...
    @Override
    public ChunkCoordinate peek() { return chunkCoord; }

    @Override
    public long count() { return diameterChunks * diameterChunks; }

    @Override
    public long covered() { return count; }
}
