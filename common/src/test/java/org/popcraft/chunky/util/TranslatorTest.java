...
public class TranslatorTest {
    ...
    private void testTranslation(String language) {
        ...
        translate("format_center", Formatting.number(1), Formatting.number(2));
        translate("format_confirm");
        translate("format_continue", "world");
        translate("format_continue_no_tasks");
        translate("format_trim_confirm", "world", translate("shape_square"), Formatting.number(1), Formatting.number(2), "500", "/chunky confirm");
        translate("format_pattern", "concentric");
        translate("format_pause", "world");
        translate("format_pause_no_tasks");
        translate("format_quiet", 1);
        translate("format_radii", Formatting.number(500), Formatting.number(1000));
        translate("format_radius", Formatting.number(500));
        translate("format_reload");
        translate("format_reload_tasks_running");
        translate("format_shape", "square");
        translate("format_silent", "enabled");
        translate("format_start", "world", translate("shape_square"), Formatting.number(1), Formatting.number(2), "500");
